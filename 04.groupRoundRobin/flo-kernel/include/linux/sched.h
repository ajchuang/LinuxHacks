...
#define M_GRR_STAT_UNSET	(0xffffffff)

struct grr_tsk_stats {

	unsigned int	m_total_rounds;		/* how many rounds it runs */
	unsigned int	m_enqueue_time;		/* last enqueue record */
	unsigned int	m_starting_time;	/* last exec record */
	unsigned int	m_leaving_time;		/* last desched record */

	unsigned int	m_load_balance_time;	/* last load balance record */
	unsigned int	m_load_balance_cnt;	/* number of LB */
};
